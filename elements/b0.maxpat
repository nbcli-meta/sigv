...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 567.0, 631.5, 55.0, 23.0 ],
					"text" : "xfade $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 567.0, 603.5, 61.0, 23.0 ],
					"text" : "line 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 289.0, 857.0, 53.0, 23.0 ],
					"text" : "route op"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 342.0, 923.0, 111.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 441.0, 966.0, 124.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 374.0, 834.0, 191.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 342.0, 883.0, 51.0, 23.0 ],
					"text" : "jit.xfade"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 126.168181818181836, 997.0, 55.0, 23.0 ],
					"text" : "jit.matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 35.25, 837.0, 47.0, 23.0 ],
					"text" : "route ^"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.75, 915.0, 55.0, 23.0 ],
					"text" : "xfade $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 64.25, 883.0, 40.0, 23.0 ],
					"text" : "line 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 125.25, 961.0, 51.0, 23.0 ],
					"text" : "jit.xfade"
				}
...
,
					"patching_rect" : [ 102.25, 778.0, 104.0, 23.0 ],
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.25, 810.0, 67.0, 23.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 157.25, 874.0, 31.0, 23.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 187.25, 748.0, 51.0, 23.0 ],
					"text" : "r ysignal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 102.25, 748.0, 51.0, 23.0 ],
					"text" : "r xsignal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 431.0, 484.0, 246.0, 52.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 27.600000000000023, 1067.0, 653.0, 37.0 ],
					"text" : "jit.gl.mesh monde @enable 1 @poly_mode 0 0 @lighting_enable 1 @animmode local @smooth_shading 1 @auto_normals 1 @blend_enable 1 @draw_mode points @point_size 2.5 @depth_enable 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 136.0, 442.5, 99.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 136.0, 365.0, 29.5, 23.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 98.600000000000023, 365.0, 29.5, 23.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 277.5, 439.0, 31.0, 23.0 ],
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 401.5, 725.0, 105.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 392.0, 592.5, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.5, 693.0, 50.0, 23.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 401.5, 664.5, 31.0, 23.0 ],
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 208.0, 47.0, 23.0 ],
					"text" : "r metro"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 533.0, 343.0, 123.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 533.0, 316.0, 62.0, 23.0 ],
					"text" : "prepend 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 533.0, 201.0, 92.0, 23.0 ],
					"text" : "importmovie $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 533.0, 232.0, 55.0, 23.0 ],
					"text" : "jit.matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 533.0, 261.0, 71.0, 23.0 ],
					"text" : "jit.gl.texture"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 477.0, 153.0, 45.0, 23.0 ],
					"text" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 477.0, 131.0, 44.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 425.0, 112.0, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 513.0, 90.0, 116.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 437.0, 38.0, 56.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 436.0, 237.0, 68.0, 23.0 ],
...
,
					"patching_rect" : [ 436.0, 206.0, 60.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 401.5, 756.5, 66.0, 23.0 ],
					"text" : "append sbj"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 293.5, 336.5, 105.0, 23.0 ],
					"text" : "prepend nodebind"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 249.0, 241.5, 152.5, 23.0 ],
					"text" : "route anim bind sel"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 267.0, 631.5, 33.0, 23.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 249.0, 383.0, 136.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 249.0, 282.5, 76.0, 23.0 ],
					"text" : "jit.anim.drive"
				}
...
,
					"patching_rect" : [ 267.0, 592.5, 56.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-70",
					"items" : [ "bio0_Scene", ",", "bio0_Cone" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 332.5, 631.5, 157.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.5, 693.0, 99.0, 23.0 ],
					"text" : "getnodenames"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 178.5, 631.5, 39.0, 23.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 178.5, 592.5, 80.0, 23.0 ],
					"text" : "unpack s i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 178.5, 556.5, 196.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 533.0, 289.5, 135.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 136.0, 298.5, 88.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 164.0, 157.0, 211.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 27.600000000000023, 100.0, 379.0, 23.0 ],
					"text" : "route anim triple reset iso tex handle . model mesh material ^ aio op gs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 98.600000000000023, 326.0, 153.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "jit.gl.model biomes @name bio0 @matrixoutput 1"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 287.0, 472.5, 84.5, 472.5 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 542.5, 417.5, 37.100000000000023, 417.5 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 72.75, 866.5, 166.75, 866.5 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 44.75, 871.0, 73.75, 871.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 37.100000000000023, 84.0, 522.5, 84.0 ],
					"order" : 0,
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 139.957142857142884, 192.5, 542.5, 192.5 ],
					"source" : [ "obj-16", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 217.100000000000023, 319.0, 37.100000000000023, 319.0 ],
					"source" : [ "obj-16", 7 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 88.528571428571453, 203.0, 145.5, 203.0 ],
					"source" : [ "obj-16", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 191.3857142857143, 181.75, 258.5, 181.75 ],
					"source" : [ "obj-16", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 114.242857142857162, 282.5, 108.100000000000023, 282.5 ],
					"source" : [ "obj-16", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 165.671428571428606, 137.5, 173.5, 137.5 ],
					"source" : [ "obj-16", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 74.25, 949.0, 134.75, 949.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 285.100000000000023, 547.25, 188.0, 547.25 ],
					"source" : [ "obj-20", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 111.75, 823.0, 178.75, 823.0 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-42", 0 ],
					"midpoints" : [ 201.75, 863.0, 166.75, 863.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 84.5, 511.0, 37.100000000000023, 511.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 249.0, 623.0, 188.0, 623.0 ],
					"source" : [ "obj-31", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 303.0, 424.25, 37.100000000000023, 424.25 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 411.0, 789.5, 381.0, 789.5, 381.0, 428.0, 287.0, 428.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 587.166666666666629, 121.5, 486.5, 121.5 ],
					"source" : [ "obj-38", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-41", 0 ],
					"midpoints" : [ 554.833333333333371, 183.0, 445.5, 183.0 ],
					"source" : [ "obj-38", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-24", 0 ],
					"midpoints" : [ 173.5, 256.25, 258.5, 256.25 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 423.0, 689.75, 674.0, 689.75 ],
					"source" : [ "obj-47", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-58", 0 ],
					"midpoints" : [ 173.5, 295.5, 37.100000000000023, 295.5 ],
					"source" : [ "obj-52", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-58", 0 ],
					"midpoints" : [ 156.0, 413.75, 37.100000000000023, 413.75 ],
					"source" : [ "obj-53", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 351.5, 953.5, 450.5, 953.5 ],
					"order" : 0,
					"source" : [ "obj-61", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-58", 0 ],
					"midpoints" : [ 71.5, 454.0, 37.100000000000023, 454.0 ],
					"source" : [ "obj-73", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-57", 0 ],
					"midpoints" : [ 332.5, 881.0, 351.5, 881.0 ],
					"source" : [ "obj-78", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-61", 0 ],
					"midpoints" : [ 298.5, 899.0, 351.5, 899.0 ],
					"source" : [ "obj-78", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 188.0, 726.0, 13.550000000000011, 726.0, 13.550000000000011, 505.0, 37.100000000000023, 505.0 ],
					"source" : [ "obj-9", 0 ]
				}
