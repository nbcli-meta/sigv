...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 49.0, 487.0, 264.0, 23.0 ],
					"text" : "jit.gl.shader monde @file shadyog.jxs @name sog"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 310.0, 341.0, 101.0, 23.0 ],
					"text" : "2. 0. 0. 1. 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 310.0, 290.0, 101.0, 23.0 ],
					"text" : "1. 0. 1. 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 310.0, 238.0, 101.0, 23.0 ],
					"text" : "0 1. 0. 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 249.0, 257.0, 52.0, 23.0 ],
					"text" : "t b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "bang", "bang" ],
					"patching_rect" : [ 185.0, 161.0, 52.0, 23.0 ],
					"text" : "t b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.0, 270.0, 101.0, 23.0 ],
					"text" : "2 0. 0.8 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.0, 219.0, 101.0, 23.0 ],
					"text" : "1 0.8 -0.8 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.0, 167.0, 101.0, 23.0 ],
					"text" : "0 -0.8 -0.8 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 12,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 33.0, 103.0, 227.0, 23.0 ],
					"text" : "route vert x y z frag r g b mesh run shader"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 33.0, 60.0, 71.0, 23.0 ],
					"text" : "route shady"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 19.0, 41.0, 23.0 ],
					"text" : "r coda"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.0, 110.0, 45.0, 23.0 ],
					"text" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 290.0, 88.0, 44.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 250.5, 51.0, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 290.0, 19.0, 116.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 209.5, 19.0, 56.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 286.0, 187.0, 68.0, 23.0 ],
...
,
					"patching_rect" : [ 249.0, 161.0, 60.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.0, 341.0, 102.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 223.0, 379.0, 171.0, 23.0 ],
					"text" : "jit.matrix color_mat 4 float32 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 311.0, 102.0, 23.0 ],
					"text" : "prepend setcell1d"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 33.0, 379.0, 177.0, 23.0 ],
					"text" : "jit.matrix vertex_mat 3 float32 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 33.0, 422.0, 302.0, 37.0 ],
					"text" : "jit.gl.mesh monde @draw_mode triangles @smooth_shading 1 @shader sog"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 118.13636363636364, 218.0, 194.5, 218.0 ],
					"source" : [ "obj-3", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 364.166666666666686, 78.5, 299.5, 78.5 ],
					"source" : [ "obj-38", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-41", 0 ],
					"midpoints" : [ 331.833333333333314, 140.0, 258.5, 140.0 ],
					"source" : [ "obj-38", 1 ]
				}
