...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 231.0, 487.0, 245.0, 23.0 ],
					"text" : "jit.gl.pass @fxname bloom-hq @threshold 0.6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 788.5, 156.5, 100.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 810.0, 133.0, 45.0, 23.0 ],
					"text" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 810.0, 111.0, 44.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 846.0, 70.0, 116.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 769.0, 40.0, 56.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 806.0, 220.0, 68.0, 23.0 ],
...
,
					"patching_rect" : [ 769.0, 186.0, 60.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 201.0, 451.0, 303.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 316.0, 160.0, 63.0, 23.0 ],
					"text" : "route . .. ..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 144.0, 396.0, 379.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 247.0, 273.0, 775.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 495.100000000000023, 325.0, 100.0, 23.0 ],
					"text" : "send metro",
					"varname" : "mtr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 385.399999999999977, 100.284477389727783, 157.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 247.0, 196.0, 197.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 247.0, 63.0, 249.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 247.0, 31.0, 100.0, 23.0 ],
					"text" : "r coda",
					"varname" : "rcoda"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 350.799999999999955, 131.0, 165.0, 23.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 333.5, 434.5, 210.5, 434.5 ],
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 634.5, 310.0, 504.600000000000023, 310.0 ],
					"source" : [ "obj-2", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 855.5, 213.0, 815.5, 213.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"midpoints" : [ 887.833333333333371, 163.0, 778.5, 163.0 ],
					"source" : [ "obj-21", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 920.166666666666629, 101.5, 819.5, 101.5 ],
					"source" : [ "obj-21", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 369.5, 344.0, 78.5, 344.0 ],
					"source" : [ "obj-38", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"midpoints" : [ 325.5, 331.5, 153.5, 331.5 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-37", 0 ],
					"midpoints" : [ 340.166666666666686, 323.0, 210.5, 323.0 ],
					"source" : [ "obj-38", 1 ]
				}
