...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 911.64285714285711, 560.0, 47.0, 23.0 ],
					"text" : "r metro"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 869.14285714285711, 638.0, 204.0, 23.0 ],
...
,
					"patching_rect" : [ 869.14285714285711, 608.0, 132.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 541.0, 560.0, 341.0, 23.0 ],
					"text" : "jit.gl.pass fxlayer @fxname gamma @quality hi @tonemapping 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 741.0, 282.0, 51.0, 23.0 ],
					"text" : "route . .."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 894.799999999999955, 297.0, 140.0, 23.0 ],
					"text" : "jit.gl.node @name fxlayer",
					"varname" : "monde[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 484.0, 505.0, 418.0, 23.0 ],
					"text" : "jit.gl.pass fxlayer @fxname atmospheric @quality hi @color 1. 2. 4. @density 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 409.0, 463.0, 418.0, 23.0 ],
					"text" : "jit.gl.pass fxlayer @fxname atmospheric @quality hi @color 1. 2. 4. @density 1."
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 619.0, 27.0, 73.0, 554.0 ],
									"text" : "aio\nasl\nbfg\nburkeshaw\nchenceli\nclifford\ncmd\ncv\ngeo\ngrain\ngraph\nhydra\nlfo\nlight\nlorenz\nlsys\nlttp\nmarkov\nmidi\nmodel\nnurbs\norca\nosc\nplato\nproc\nrossler\nsketch\nsky\nsom\nspecs\nspk\nspx\nsynth\nterminal\nterra\ntex0\ntilde\nwave"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 39,
									"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
									"patching_rect" : [ 44.0, 67.0, 656.0, 37.0 ],
									"text" : "route aio asl bfg burkeshaw chenceli clifford cmd cv geo grain graph hydra lfo light lorenz lsys lttp markov midi model nurbs orca osc plato proc rossler sketch sky som specs spk spx synth terminal terra tex0 tilde wave"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 17.0, 21.0, 64.0, 23.0 ],
									"text" : "route spec"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 17.0, 138.0, 373.0, 23.0 ],
									"text" : "anim triple reset iso material gs1 gs2 ^ handle op export mesh aio vo"
								}
...
,
					"patching_rect" : [ 553.0, 200.0, 52.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 257.284477389727783, 100.0, 23.0 ],
					"text" : "s coda"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 156.0, 33.0, 105.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 204.0, 170.0, 100.0, 23.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 204.0, 200.0, 100.0, 23.0 ],
					"text" : "route bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.5, 170.0, 100.0, 23.0 ],
					"text" : "receive~ audio"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.5, 199.0, 100.0, 5.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 174.0, 26.0, 100.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 445.0, 63.0, 116.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 672.0, 362.0, 607.0, 23.0 ],
					"text" : "jit.world sigv @fsmenubar 0 @visible 1 @enable 1 @erase_color 0 0 0 1 @size 1024 575 @dim 1920 1080 @fsaa 1",
					"varname" : "wrld"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 835.100000000000023, 414.0, 100.0, 23.0 ],
					"text" : "send metro",
					"varname" : "mtr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 810.399999999999977, 222.284477389727783, 157.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 672.0, 318.0, 165.0, 23.0 ],
					"text" : "jit.gl.layer @layer 1 @enable 0",
					"varname" : "movie"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 672.0, 185.0, 249.0, 23.0 ],
					"text" : "route movie wrld fx monde camera fxlayer pix",
					"varname" : "movie_route"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 672.0, 153.0, 100.0, 23.0 ],
					"text" : "r coda",
					"varname" : "rcoda"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 775.799999999999955, 253.0, 165.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 553.0, 257.284477389727783, 100.0, 23.0 ],
					"text" : "terminal",
					"varname" : "terminal[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 409.0, 350.0, 100.0, 23.0 ],
					"text" : "specs",
					"varname" : "specs"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 618.0, 495.0, 493.5, 495.0 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 693.0, 543.5, 550.5, 543.5 ],
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 975.5, 399.0, 844.600000000000023, 399.0 ],
					"source" : [ "obj-2", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-33", 0 ],
					"midpoints" : [ 858.299999999999955, 286.0, 904.299999999999955, 286.0 ],
					"source" : [ "obj-20", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 454.5, 206.0, 414.5, 206.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"midpoints" : [ 486.833333333333314, 156.0, 377.5, 156.0 ],
					"source" : [ "obj-21", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 519.166666666666629, 94.5, 418.5, 94.5 ],
					"source" : [ "obj-21", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 782.5, 453.0, 418.5, 453.0 ],
					"source" : [ "obj-38", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"midpoints" : [ 750.5, 440.5, 493.5, 440.5 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-37", 0 ],
					"midpoints" : [ 766.5, 432.0, 550.5, 432.0 ],
					"source" : [ "obj-38", 1 ]
				}
