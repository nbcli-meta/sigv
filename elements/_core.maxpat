...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 417.0, 110.0, 45.0, 23.0 ],
					"text" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 417.0, 92.0, 44.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 310.0, 26.0, 23.0 ],
					"text" : "osc"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 95.0, 310.0, 100.0, 23.0 ],
					"text" : "s coda"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 204.0, 122.0, 100.0, 23.0 ],
					"text" : "receive~ audio"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 181.5, 119.0, 90.0, 5.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 368.0, 171.0, 68.0, 23.0 ],
...
,
					"patching_rect" : [ 368.0, 139.0, 68.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 381.0, 397.0, 100.0, 23.0 ],
					"text" : "send metro",
					"varname" : "mtr"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 500.0, 198.0, 155.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.0, 133.0, 100.0, 23.0 ],
					"text" : "r coda",
					"varname" : "rcoda"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 99.0, 394.0, 100.0, 23.0 ],
					"text" : "tilde",
					"varname" : "tilde"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 99.0, 419.0, 100.0, 23.0 ],
					"text" : "terminal",
					"varname" : "terminal[1]"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 454.5, 133.0, 377.5, 133.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"midpoints" : [ 486.833333333333314, 117.0, 377.5, 117.0 ],
					"source" : [ "obj-21", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 519.166666666666629, 92.0 ],
					"source" : [ "obj-21", 2 ]
				}
