...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 848.799999999999955, 288.0, 140.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 484.0, 542.0, 145.0, 23.0 ],
					"text" : "jit.gl.layer fxlayer @layer 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 484.0, 505.0, 439.0, 23.0 ],
					"text" : "jit.gl.pass fxlayer @fxname bloom @bloom_amt 1. @blur_width 1. @threshold 0.95"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 409.0, 463.0, 443.0, 23.0 ],
					"text" : "jit.gl.pass fxlayer @fxname dof @focal_distance 2. @focal_range 1. @blur_width 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 672.0, 185.0, 192.0, 23.0 ],
					"text" : "route movie wrld fx monde camera",
					"varname" : "movie_route"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 630.5, 495.0, 493.5, 495.0 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 750.700000000000045, 453.0, 418.5, 453.0 ],
					"source" : [ "obj-14", 2 ]
				}
